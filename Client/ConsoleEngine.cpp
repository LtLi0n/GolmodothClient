...
void ConsoleEngine::UpdateMousePosition(int x, int y)
{
...
void ConsoleEngine::ToggleFullscreen(HWND hWnd)
{
...
void ConsoleEngine::WindowResize(void)
{
...
void ConsoleEngine::WindowUpdateScale(void)
{
...
int ConsoleEngine::SetPixelFormatGL(void)
{
...
LRESULT CALLBACK ConsoleEngine::olcWndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	static ConsoleEngine *cge;
...
HWND ConsoleEngine::ConstructWindow(int width, int height)
{
...
void ConsoleEngine::FillTriangle(int x1, int y1, int x2, int y2, int x3, int y3, short c, short col)
{
...
void ConsoleEngine::DrawWireFrameModel(const std::vector<std::pair<float, float>> &vecModelCoordinates, float x, float y, float r, float s, short col, short c)
{
...
void ConsoleEngine::GenerateMipmapPow2(uint8_t *tex_new, uint8_t *tex_old, uint8_t *ref_alpha, int size)
{
...
void ConsoleEngine::StopSample(int id)
{
